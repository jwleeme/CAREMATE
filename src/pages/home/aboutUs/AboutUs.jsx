    ...
    <div className={cx('wrapper')}>
      <div className={styles.flexContainer}>
        <div className={styles.flexMainItem}>
          ...
          <div>
            <MainText>
              돌봄이 중요한 현 시기에 여러 사람들이
              <br /> 함께 살아가는 공동체를 위해 만들어진 플랫폼입니다.
              <br /> 지역사회를 위한 봉사활동과 돌봄 서비스를 제공하며,
              <br /> 이를 통해 사회에 좋은 영향력을 끼치려고 합니다.
              <br />
              우리의 목표는 서로 돕고 함께 사는 아름다운 공동사회를 만들어가는 것입니다.
            </MainText>
          </div>
        </div>
        ...
        <div className={styles.cardWrapper}>
          <FlexItem backgroundColor="#ffefef" hoverColor="#ffd6d6">
            <div className={styles.cardContainer} style={{ display: 'flex', flexDirection: 'column' }}>
              <Title style={{ flex: 1 }}>
                <div>쓰담쓰담은</div>
                <div>
                  <span style={{ color: 'black' }}>돌봄이 필요한 모든이들</span>을 위한
                  <br /> 서비스입니다.
                </div>
              </Title>
              <Text style={{ flex: 1 }}>
